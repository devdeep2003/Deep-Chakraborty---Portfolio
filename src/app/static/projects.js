export const projectData = [
  ...
  {
    "id": 2,
    "name": "MVA Community — Apartment Management Platform",
    "description": "Developed a role-based apartment platform for 50+ users with complaint, payment, and rental modules. Integrated Supabase Auth and real-time DB to automate workflows. Reduced manual complaint resolution time by 40%.",
